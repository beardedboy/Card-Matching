...
(function () {
    ...
    var initGame = function initGame(event) {
    ...
    function createNewElement() {
        ...
        var js = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
        var content = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
        ...
        for (var _len = arguments.length, classNames = Array(_len > 4 ? _len - 4 : 0), _key = 4; _key < _len; _key++) {
            classNames[_key - 4] = arguments[_key];
        }
    ...
    function screenTransition() {
        ...
        var animateElement = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
        var timeDelay = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
